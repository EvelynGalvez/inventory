        ...
        <div class="w-1/2 bg-white rounded shadow-2xl p-8 m-4" style="padding: 30px">
            ...
            <form action="/" method="post">
                <div class="flex flex-col mb-4">
                    ...
                    <input class="border py-2 px-3 text-grey-800" type="text" name="first_name" id="first_name" value="{{$id}}">
                </div>
                <div class="flex flex-col mb-4">
                    <label class="mb-2 font-bold text-lg text-gray-900" for="last_name">Código Producto</label>
                    <input class="border py-2 px-3 text-grey-800" type="text" name="last_name" id="last_name" value="{{$codigo}}">
                </div>
                <div class="flex flex-col mb-4">
                    <label class="mb-2 font-bold text-lg text-gray-900" for="last_name">Nombre Producto</label>
                    <input class="border py-2 px-3 text-grey-800" type="text" name="last_name" id="last_name" value="{{$nombre}}">
                </div>
                <div class="flex flex-col mb-4">
                    <label class="mb-2 font-bold text-lg text-gray-900" for="last_name">Categoría</label>
                    <input class="border py-2 px-3 text-grey-800" type="text" name="last_name" id="last_name" value="{{$categoria}}">
                </div>
                <div class="flex flex-col mb-4">
                    <label class="mb-2 font-bold text-lg text-gray-900" for="last_name">Sucursal</label>
                    <input class="border py-2 px-3 text-grey-800" type="text" name="last_name" id="last_name" value="{{$sucursal}}">
                </div>
                <div class="flex flex-col mb-4">
                    <label class="mb-2 font-bold text-lg text-gray-900" for="last_name">Descripción</label>
                    <input class="border py-2 px-3 text-grey-800" type="text" name="last_name" id="last_name" value="{{$descripcion}}">
                </div>
                <div class="flex flex-col mb-4">
                    <label class="mb-2 font-bold text-lg text-gray-900" for="last_name">Cantidad</label>
                    <input class="border py-2 px-3 text-grey-800" type="text" name="last_name" id="last_name" value="{{$cantidad}}">
                </div>
                <div class="flex flex-col mb-4">
